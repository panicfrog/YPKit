...
#define MAVLINK_MSG_ID_SET_QUAD_SWARM_ROLL_PITCH_YAW_THRUST_LEN 46
#define MAVLINK_MSG_ID_61_LEN 46

#define MAVLINK_MSG_ID_SET_QUAD_SWARM_ROLL_PITCH_YAW_THRUST_CRC 89
#define MAVLINK_MSG_ID_61_CRC 89
...
#define MAVLINK_MSG_SET_QUAD_SWARM_ROLL_PITCH_YAW_THRUST_FIELD_LED_RED_LEN 4
#define MAVLINK_MSG_SET_QUAD_SWARM_ROLL_PITCH_YAW_THRUST_FIELD_LED_BLUE_LEN 4
#define MAVLINK_MSG_SET_QUAD_SWARM_ROLL_PITCH_YAW_THRUST_FIELD_LED_GREEN_LEN 4
...
#define MAVLINK_MESSAGE_INFO_SET_QUAD_SWARM_ROLL_PITCH_YAW_THRUST { \
	...
	{  { "roll", NULL, MAVLINK_TYPE_INT16_T, 4, 0, offsetof(mavlink_set_quad_swarm_roll_pitch_yaw_thrust_t, roll) }, \
         ...
         { "led_red", NULL, MAVLINK_TYPE_UINT8_T, 4, 34, offsetof(mavlink_set_quad_swarm_roll_pitch_yaw_thrust_t, led_red) }, \
         { "led_blue", NULL, MAVLINK_TYPE_UINT8_T, 4, 38, offsetof(mavlink_set_quad_swarm_roll_pitch_yaw_thrust_t, led_blue) }, \
         { "led_green", NULL, MAVLINK_TYPE_UINT8_T, 4, 42, offsetof(mavlink_set_quad_swarm_roll_pitch_yaw_thrust_t, led_green) }, \
         } \
}
...
{
	return mavlink_msg_set_quad_swarm_roll_pitch_yaw_thrust_pack(system_id, component_id, msg, set_quad_swarm_roll_pitch_yaw_thrust->group, set_quad_swarm_roll_pitch_yaw_thrust->mode, set_quad_swarm_roll_pitch_yaw_thrust->led_red, set_quad_swarm_roll_pitch_yaw_thrust->led_blue, set_quad_swarm_roll_pitch_yaw_thrust->led_green, set_quad_swarm_roll_pitch_yaw_thrust->roll, set_quad_swarm_roll_pitch_yaw_thrust->pitch, set_quad_swarm_roll_pitch_yaw_thrust->yaw, set_quad_swarm_roll_pitch_yaw_thrust->thrust);
}
...
static inline void mavlink_msg_set_quad_swarm_roll_pitch_yaw_thrust_send(mavlink_channel_t chan, uint8_t group, uint8_t mode, const uint8_t *led_red, const uint8_t *led_blue, const uint8_t *led_green, const int16_t *roll, const int16_t *pitch, const int16_t *yaw, const uint16_t *thrust)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_SET_QUAD_SWARM_ROLL_PITCH_YAW_THRUST_LEN];
	_mav_put_uint8_t(buf, 32, group);
 ...
 */
static inline void mavlink_msg_set_quad_swarm_roll_pitch_yaw_thrust_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t group, uint8_t mode, const uint8_t *led_red, const uint8_t *led_blue, const uint8_t *led_green, const int16_t *roll, const int16_t *pitch, const int16_t *yaw, const uint16_t *thrust)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field led_red from set_quad_swarm_roll_pitch_yaw_thrust message
 *
 * @return RGB red channel (0-255)
 */
static inline uint16_t mavlink_msg_set_quad_swarm_roll_pitch_yaw_thrust_get_led_red(const mavlink_message_t* msg, uint8_t *led_red)
{
	return _MAV_RETURN_uint8_t_array(msg, led_red, 4,  34);
}

/**
 * @brief Get field led_blue from set_quad_swarm_roll_pitch_yaw_thrust message
 *
 * @return RGB green channel (0-255)
 */
static inline uint16_t mavlink_msg_set_quad_swarm_roll_pitch_yaw_thrust_get_led_blue(const mavlink_message_t* msg, uint8_t *led_blue)
{
	return _MAV_RETURN_uint8_t_array(msg, led_blue, 4,  38);
}

/**
 * @brief Get field led_green from set_quad_swarm_roll_pitch_yaw_thrust message
 *
 * @return RGB blue channel (0-255)
 */
static inline uint16_t mavlink_msg_set_quad_swarm_roll_pitch_yaw_thrust_get_led_green(const mavlink_message_t* msg, uint8_t *led_green)
{
...
static inline void mavlink_msg_set_quad_swarm_roll_pitch_yaw_thrust_decode(const mavlink_message_t* msg, mavlink_set_quad_swarm_roll_pitch_yaw_thrust_t* set_quad_swarm_roll_pitch_yaw_thrust)
{
	...
	mavlink_msg_set_quad_swarm_roll_pitch_yaw_thrust_get_led_red(msg, set_quad_swarm_roll_pitch_yaw_thrust->led_red);
	mavlink_msg_set_quad_swarm_roll_pitch_yaw_thrust_get_led_blue(msg, set_quad_swarm_roll_pitch_yaw_thrust->led_blue);
	mavlink_msg_set_quad_swarm_roll_pitch_yaw_thrust_get_led_green(msg, set_quad_swarm_roll_pitch_yaw_thrust->led_green);
#else
