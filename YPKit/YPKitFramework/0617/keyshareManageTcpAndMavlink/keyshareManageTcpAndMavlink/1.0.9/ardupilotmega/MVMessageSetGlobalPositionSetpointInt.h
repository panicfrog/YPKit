//
//  MVMessageSetGlobalPositionSetpointInt.h
...
/*!
 Class that represents a SET_GLOBAL_POSITION_SETPOINT_INT Mavlink message.

 @discussion Set the current global position setpoint.
 */
@interface MVMessageSetGlobalPositionSetpointInt : MVMessage
